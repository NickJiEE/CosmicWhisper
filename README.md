...
Through my design and collaboration with a team member, all the systems also connect to Wi-Fi to send and receive real-time game status data using web service requests onto a Google Sheets, with support of App Scripts. This allows clean management for events since there will be multiple games being played.
